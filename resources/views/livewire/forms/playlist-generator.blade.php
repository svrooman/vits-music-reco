<div class="relative min-h-[400px]">
    ...
    <!-- Replace Track Modal - Bootstrap-style structure with Tailwind styling -->
    @if($showReplaceModal && isset($generatedTracks[$replaceTrackIndex]))
        <!-- Modal backdrop (like Bootstrap's modal-backdrop) -->
        <div class="fixed inset-0 bg-black bg-opacity-50 z-40" wire:click="closeReplaceModal"></div>

        <!-- Modal (like Bootstrap's .modal) -->
        <div class="fixed inset-0 overflow-y-auto z-50" tabindex="-1" role="dialog" aria-modal="true">
            <!-- Modal dialog (like Bootstrap's .modal-dialog) -->
            <div class="flex items-center justify-center min-h-screen p-4">
                <!-- Modal content (like Bootstrap's .modal-content) -->
                <div class="relative bg-white rounded-lg shadow-xl w-full max-w-lg" wire:click.stop>
                    @php
                        $track = $generatedTracks[$replaceTrackIndex];
                    @endphp

                    <!-- Modal header (like Bootstrap's .modal-header) -->
                    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-900">Replace Track</h3>
                        <button wire:click="closeReplaceModal" type="button" class="text-gray-400 hover:text-gray-600">
                    ...
                    <!-- Modal body (like Bootstrap's .modal-body) -->
                    <div class="p-6">
                    ...
                    <!-- Modal footer (like Bootstrap's .modal-footer) -->
                    <div class="flex gap-3 justify-end px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <button wire:click="closeReplaceModal" type="button"
                                class="px-4 py-2 border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 font-medium rounded-lg">
                            Cancel
                        </button>
